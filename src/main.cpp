...
int main(int argc, char *argv[])
{
    ...
    ALLEGRO_COLOR collisionIndicatorColor = al_map_rgb(20, 140, 20);
    ...
    while (gameActive)
    {
        ...
        case ALLEGRO_EVENT_TIMER:
            ...
            {
                collisionIndicatorColor = al_map_rgb(140, 20, 20);
            }
            else
            {
                collisionIndicatorColor = al_map_rgb(20, 140, 20);
            } // placeholder collision detection and visualization
        ...
        if (redraw && al_is_event_queue_empty(eventQueue))
        {
            ...
            // collision
            al_draw_filled_circle(800, 400, 30, collisionIndicatorColor);
